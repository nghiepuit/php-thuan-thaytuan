			...
			<div class="panel-body" style="display: block;">
				...
				<div class="form-group">
					...
					<div class="col-lg-9" style="padding-left:0px">
						...
						<input type="text" name="txtPass" class="form-control" placeholder="Enter your password" <?php issetInput ('txtPass') ?> />
		...
		<div class="panel panel-default">
			...
			<div class="panel-body" style="display: block;">
				...
				<div class="checkbox checkbox-switch">
					<input type="checkbox" name="chkStatus" data-on-color="success" data-off-color="danger" data-on-text="Status Online" data-off-text="Status Offline" class="switch" <?php isssetCheckbox ("chkStatus") ?> />
				</div>
			</div>
		</div>
	</div>
